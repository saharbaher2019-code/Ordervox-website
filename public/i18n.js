  ...
  en: {
    ...
    tour: {
      ...
      row1: {
        ...
        li3: "Auto-detects English, Spanish, or Dari and keeps speaking it",
  ...
  es: {
    ...
    tour: {
      ...
      row1: {
        ...
        li3: "Detecta automáticamente inglés, español o darí y sigue hablando en ese idioma",
  ...
  prs: {
    ...
    tour: {
      ...
      row1: {
        ...
        li3: "انگلیسی، اسپانیایی یا دری را خودکار تشخیص داده و به همان زبان ادامه می‌دهد",
